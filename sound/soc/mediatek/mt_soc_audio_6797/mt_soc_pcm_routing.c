...
static char const *DAC_DL_SINEGEN_SAMEPLRATE[] = {
	"8K", "11K", "12K", "16K",
	"22K", "24K", "32K", "44K",
	"48K", "88k", "96k", "176k",
	"192k"
...
static char const *DAC_DL_SINEGEN_AMPLITUE[] = {
	"1/128", "1/64", "1/32", "1/16", "1/8", "1/4", "1/2", "1" };

static bool mEnableSideToneFilter;
static char const *ENABLESTF[] = { "Off", "On" };

static int mAudio_Mode;
static char const *ANDROID_AUDIO_MODE[] = {
	"Normal_Mode", "Ringtone_Mode", "Incall_Mode", "Communication_Mode", "Incall2_Mode",
	    "Incall_External_Mode"
};
static char const *InterModemPcm_ASRC_Switch[] = { "Off", "On" };
static char const *Audio_Debug_Setting[] = { "Off", "On" };
static char const *Audio_IPOH_State[] = { "Off", "On" };
static char const *Audio_I2S1_Setting[] = { "Off", "On" };
